    ...
    <div class="min-h-screen flex flex-col items-center justify-center">
        ...
        <div class="card w-full max-w-md bg-white dark:bg-white shadow-md rounded-lg p-6">
            <div class="card-header text-center mb-4">
                <h2 class="text-2xl font-semibold text-[#211d70]">{{ __('Email Verification') }}</h2>
            </div>
            ...
            <form method="POST" action="{{ route('verification.verify') }}">
                ...
                <div class="mb-4">
                    <label for="verification_code" class="block text-sm font-medium text-gray-700 dark:text-gray-700">Verification Code:</label>
                    <input type="text" id="verification_code" name="verification_code" class="form-control mt-1 block w-full rounded-md border-gray-300 dark:bg-gray-200 dark:border-gray-300 text-black" required pattern="\d{6}" title="Please enter a 6-digit code" maxlength="6">
                </div>
