                            ...
                            <div class="card-body text-center">
                                ...
                                <ul class="list-unstyled">
                                    @if ($roommate['details']['age'])
                                        <li>Age: Similar ({{ $roommate['details']['age'] }} points)</li>
                                    @endif
                                    @if ($roommate['details']['nationality'])
                                        <li>Nationality: Match ({{ $roommate['details']['nationality'] }} points)</li>
                                    @endif
                                    @if ($roommate['details']['interests'])
                                        <li>Interests: {{ $roommate['details']['interests'] }} common interests ({{ $roommate['details']['interests_points'] }} points)</li>
                                    @endif
                                    @if ($roommate['details']['lifestyles'])
                                        <li>Lifestyles: {{ $roommate['details']['lifestyles'] }} common lifestyles ({{ $roommate['details']['lifestyles_points'] }} points)</li>
                                    @endif
                                    @if ($roommate['details']['preferences'])
                                        <li>Preferences: {{ $roommate['details']['preferences'] }} common preferences ({{ $roommate['details']['preferences_points'] }} points)</li>
                                    @endif
                                </ul>
